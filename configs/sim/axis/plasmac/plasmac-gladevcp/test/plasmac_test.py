...
class plasmacTest:
    ...
    def __init__(self):
        ...
        self.halcomp.ready()
        sp.Popen(['halcmd net pt:arc-voltage-in plasmactest.arcVoltage plasmac.arc-voltage-in'], shell=True)
        sp.Popen(['halcmd net pt:float-switch plasmactest.floatSwitch debounce.0.0.in'], shell=True)
        sp.Popen(['halcmd net pt:arc-ok-in plasmactest.arcOk plasmac.arc-ok-in'], shell=True)
        sp.Popen(['halcmd net pt:move-up plasmactest.moveUp plasmac.move-up'], shell=True)
        sp.Popen(['halcmd net pt:move-down plasmactest.moveDown plasmac.move-down'], shell=True)
        sp.Popen(['halcmd net pt:breakaway-switch plasmactest.breakawaySwitch debounce.0.1.in'], shell=True)
